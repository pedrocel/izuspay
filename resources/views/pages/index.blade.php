                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <div class="flex items-center space-x-1">
                                    <a href="{{ route('pages.show', $page->name) }}" class="p-2 text-gray-500 hover:text-purple-600 dark:text-gray-400 dark:hover:text-purple-400 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors transform hover:scale-110 duration-200" title="Visualizar">
                                    ...
                                    <form action="{{ route('pages.destroy', $page->id) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir esta página?')">
                                        @csrf
                                        @method('DELETE')
