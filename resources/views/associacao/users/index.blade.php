    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="flex gap-2">
                <select class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
            ...
            <div class="p-6">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative">
                            @if($user->avatar_url)
                                <img class="w-14 h-14 rounded-full object-cover border-2 border-green-200 dark:border-green-700" 
                                     src="{{ $user->avatar_url }}" 
                                     alt="{{ $user->name }}">
                            @else
