<x-app-layout>
    ...
    <div class="container mx-auto">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-medium">Gerenciamento de Lojas</h2>
            <a href="{{ route('admin.stores.create') }}" class="btn-create">
  Cadastrar Nova Loja
</a>
        </div>
            ...
            <tbody>
                @forelse($stores as $store)
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <a href="{{ route('admin.stores.edit', $store) }}" class="text-blue-500 hover:underline">Editar</a>
                            <form action="{{ route('admin.stores.destroy', $store) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center py-4 text-gray-500">Nenhuma loja cadastrada.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
