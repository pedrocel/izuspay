...
@section('title', 'Planos - Administração')
...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
            ...
            <div class="p-6 flex-grow">
                ...
                <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                    <li class="flex items-center"><i data-lucide="check" class="w-4 h-4 text-green-500 mr-2"></i> {{ Str::limit($plan->description, 50) }}</li>
                    <li class="flex items-center"><i data-lucide="check" class="w-4 h-4 text-green-500 mr-2"></i> Duração: {{ $plan->duration_in_months ?? '-' }} meses</li>
                    <li class="flex items-center"><i data-lucide="check" class="w-4 h-4 text-green-500 mr-2"></i> Produtos Associados: {{ $plan->products->count() }}</li>
                </ul>
            </div>
        ...
        <div class="md:col-span-2 xl:col-span-3 bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 p-12 text-center flex flex-col items-center justify-center">
            ...
            <a href="#" 
               class="inline-flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:transform hover:scale-105 shadow-lg hover:shadow-xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full m-4 p-6 shadow-2xl transform transition-all"
        ...
        <div class="flex flex-col items-center text-center">
            ...
            <div class="flex justify-center space-x-4 w-full">
                <button onclick="closeDeleteModal()" class="flex-1 px-4 py-2.5 text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-lg font-semibold transition-colors">
                    Cancelar
                </button>
...
<script>
    ...
    function confirmDelete(planId, planName) {
        ...
        // Ajuste a rota de exclusão conforme a sua rota real para planos de administração
