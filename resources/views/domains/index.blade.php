...
<header class="glass-effect border-b border-gray-200/50 dark:border-gray-700/50 sticky top-0 z-20">
    <div class="flex justify-between items-center px-4 md:px-8 py-6">
        ...
        <div class="flex items-center space-x-4">
            <a href="{{ route('domains.create') }}" class="theme-gradient text-white px-4 py-2 rounded-lg flex items-center space-x-2 hover:opacity-90 transition-opacity duration-150">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden p-6">
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <form action="{{ route('domains.destroy', $domain->id) }}" method="POST" onsubmit="return confirm('Deseja excluir?')">
                        @csrf
                        @method('DELETE')
        ...
        <div class="col-span-full bg-white dark:bg-gray-800 rounded-xl p-8 text-center">
            <div class="flex flex-col items-center justify-center">
                ...
                <a href="{{ route('domains.create') }}" class="theme-gradient hover:bg-indigo-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition duration-200">
                    <i data-lucide="plus" class="w-5 h-5"></i>
